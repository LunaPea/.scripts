...
COMMANDS["surfraw"]="~/scripts/search.sh"
LABELS["surfraw"]=""

# make a screenshot
COMMANDS["screenshot"]='screengrab'
LABELS["screenshot"]=""

# exit session (not the best way to do that)
COMMANDS["kill_Xorg"]='killall Xorg'
LABELS["kill_Xorg"]=""
...
# COMMANDS["pirate"]="firefox --disk-cache-dir=/tmp/cache http://thepiratebay.org/search/\" \${input}\""
# LABELS["pirate"]=""
...
function start()
{
    ...
    print_menu | sort | rofi -dmenu -mesg ">>> launch your collection of scripts" -i -p "rofi-bangs: "
